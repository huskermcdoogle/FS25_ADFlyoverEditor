...
TOOLS = [
    {
        ...
        "controls": [
            ("Point popup", "name, move, connect, spline, make two-way / one-way, primary / "
                            "secondary, delete point."),
            ("Span / run popup", "move, straighten, smooth, divide, ground (+ parallel on a run), "
                                 "make two-way / one-way, flip direction, delete."),
            ("Selection popup", "move, clear, make two-way / one-way, other way, primary / secondary, "
                                "delete selection. Conversions only touch links BETWEEN selected points."),
        ],
    },
    {
