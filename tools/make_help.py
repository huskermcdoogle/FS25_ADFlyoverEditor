    ...
    },
    {
        ...
        "controls": [
            ...
            ("detect custom field", "on by default; when Courseplay is active, also finds ground "
                                     "plowed to connect two separate map fields into one (via a "
                                     "live scan, which can take a moment - the tool card says so "
                                     "while it works) or a boundary recorded with Courseplay's "
                                     "custom-field tool, not just a field shipped with the map. No "
                                     "effect without Courseplay. Turn it off to fall back to the "
