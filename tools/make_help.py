...
TOOLS = [
    ...
    },
    {
        ...
        "how": [
            ...
            "With copy on, \"break\" additionally deletes the originals once the copy is made - "
            "the piece ends up relocated, not duplicated.",
            ...
            "right-click to finish. A stray click elsewhere is ignored while one is pending.",
